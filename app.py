...
<head>
    ...
    <style>
        body {
            background-image: url('https://i.ibb.co/q30XxNFh/20250718-125730.jpg');
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=22070)
