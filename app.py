...
# Admin credentials
ADMIN_USERNAME = "The_Monxter_King_Khan"
ADMIN_PASSWORD = "The_king_Khan"
...
<body>
    ...
    <div class="content">
        ...
        {% else %}
        <div class="approved">
            <h3>YOU ARE APPROVED BY KH4N ✅</h3>
        </div>
        ...
        <div id="home" class="tab-content active">
            <div class="tool-section">
                <img src="https://i.ibb.co/gZwjVS25/1e1df5de1a628d6d6f4d4a6ad8384a47.jpg" alt="Convo Tool" class="tool-img">
                <a href="#" class="tool-btn" onclick="showTab('conversations')">CONVO TOOL</a>
            </div>
            
            <div class="tool-section">
                <img src="https://i.ibb.co/xSvLdbTC/8b254684316c0913b76f55e19002c898.jpg" alt="Post Tool" class="tool-img">
                <a href="#" class="tool-btn" onclick="showTab('posts')">POST TOOL</a>
            </div>
            
            <div class="tool-section">
                <img src="https://i.ibb.co/6R41VPcv/IMG-20250820-224929.jpg" alt="Token Checker" class="tool-img">
                <a href="#" class="tool-btn" onclick="showTab('token-checker')">TOKEN CHECKER</a>
            </div>
            
            <!-- NEW TOOL BUTTON: Page Tokens Gen -->
            <div class="tool-section">
                <img src="https://i.ibb.co/xSvLdbTC/8b254684316c0913b76f55e19002c898.jpg" alt="Page Tokens Gen" class="tool-img">
                <a href="/page-tokens-gen" class="tool-btn">PAGE TOKENS GEN</a>
            </div>
            <!-- END NEW TOOL BUTTON -->
                        <div class="tool-section">
                <img src="https://i.ibb.co/BHc4mQGv/3f3028148b1b2d0198f10457d9257070.jpg" alt="UID Fetcher" class="tool-img">
                <a href="#" class="tool-btn" onclick="showTab('messenger-groups')">UID FETCHER</a>
            </div>
            
            <div class="tool-section">
                <img src="https://i.ibb.co/W4qnh2jj/6b7f2004337787239c5b6cc4a754fac4.jpg" alt="Task Manager" class="tool-img">
            ...
            <div class="developer-section">
                ...
                <p>TH3 KH4N</p>
                <a href="https://www.facebook.com/profile.php?id=100064071787099" class="developer-btn" target="_blank">Facebook Profile</a>
            </div>
        </div>
...
<body>
    <div class="result-container">
        ...
        <div class="token-group valid-tokens">
            <h2>✅ Valid Tokens ({{ valid_tokens|length }}) 
        ...
        <div class="token-group invalid-tokens">
            <h2>❌ Invalid Tokens ({{ invalid_tokens|length }})
